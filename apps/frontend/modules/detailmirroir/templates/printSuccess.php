...
<table width="80%" class="table-condensed" border="2">
  <thead>
    <tr>
      <th>&nbsp;</th>
        <th>Largeur</th>
...
$deleted = Doctrine_Query::create()
  ...
  ->execute();
	 ...
	 ?>
      ...
      <td>A<?php echo $rd_detail_mirroir->getId() - $nber + 1 ?>&nbsp;</td>
	  ...
	  foreach ($totallargeur as $largeur)
  {
    ...
    echo $totallargeur =$largeur->getLargeurMin();  }?></td>
      <td><?php 
	  $totallargeur = Doctrine_Query::create()
						// ->select('a.*, sum(a.price) as price')
	  ...
	  foreach ($totallargeur as $largeur)
  {
    ...
    $totaldeshauteurs =$largeur->getHauteurMin();

	$grandtotal=($totaldeshauteurs+$totallargeur)*4/100;}?></td>
      <td><?php 
...
?></td>
	  ...
	  foreach ($totallargeurvitre as $largeurvitre)
  {
    ...
    // echo "L = ".$totallargeurvitre =$largeurvitre->getLargeurVitre()."  ";  
     $totallargeurvitre =$largeurvitre->getLargeurVitre() ;  
	}
