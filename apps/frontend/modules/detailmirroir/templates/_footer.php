...
?> <ul>
	  <li class="offset4"><i class="icon-ok"></i>&nbsp;&nbsp;<?php echo $elements*4;?> Rouletttes
	  <i class="icon-ok"></i>&nbsp;&nbsp; <?php echo $elements*2;?> Serrures
<i class="icon-ok"></i>&nbsp;&nbsp;<?php echo $grandtotal;//$elements*1;?> metres de Joint de vitrage
