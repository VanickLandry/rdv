  ...
  <thead>
    <tr>
      <th>&nbsp;</th>
		...
		<th>Traverse:</th>
		<th>Largeur vitre:</th>
		<th>Hauteur vitre:</th><th>Total:</th>
		<!--<th>Quantite:</th>-->
...
?>&nbsp;</td>
 ...
 ?>&nbsp;</td>
      ...
      <td colspan="2"><span class="label label-info"><?php
	  echo ($t=ceil($total_prix_mesure_raisbas)+ceil($total_prix_mesure_raishaut)+ceil($total_prix_mesure_dormant)
...
?></td>
	   <td colspan="2">-</td>
       <td colspan="2"><span class="label label" style="font-size:18px;background:rgb(255,242,0);color:rgb(0,0,0)"><?php echo $percenttotal;?></span></td>
    </tr>
  </tbody>
</table>
...
<a class="btn btn-danger" href="<?php echo url_for('detailmirroir/couvrejoint')  ?>" target="_blank">CP couvre joint hauteur</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-danger" href="<?php echo url_for('detailmirroir/couvrejoint2')  ?>" target="_blank">CP couvre joint largeur</a>&nbsp;&nbsp;&nbsp;  <a class="btn btn-danger" href="<?php echo url_for('detailmirroir/dormant')  ?>" target="_blank">CP dormant</a>&nbsp;&nbsp;&nbsp;
  ...
  <a class="btn btn-primary" href="<?php echo url_for('detailmirroir/printclient') ?>" target="_blank" data-toggle="modal" data-target="#myModal">Print to client</a>&nbsp;&nbsp;&nbsp;
<!-- Button trigger modal -->
 

<!-- Modal -->
<div class="modalo fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel">Adding a Client</h4>
      </div>
      <div class="modal-body">
	  
<?php 		 $form = new ClientForm();

include_partial('client/form', array('form' => $form)) ?>
      </div>
      <!--<div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <input type="submit" class="btn btn-primary" value="Save changes and continue">
      </div>-->
    </div>
  </div>
</div>
