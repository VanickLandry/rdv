...
?></td>
	 ...
	 foreach ($totalhauteurvitre as $hauteurvitre)
  {
	...
	$totalvitre =($hauteurvitre->getLargeurVitre()*$totallargeur =$largeur->getHauteurVitre())/10000;
	echo "T = ".$totalvitre;
	}
	
	?></td>
	<td colspan="2"><?php  echo $totalchicone+$totaldormant+$totaltraverse+$totalsernie+$totalraishaut+$totalraisbas+$totallargeurcouvrejoint+$totalhauteurcouvrejoint+$totalhauteurvitre+$totallargeurvitre;
...
?>&nbsp;</td>
 ...
 ?>&nbsp;</td>
      ...
      <td colspan="2"><?php
	  echo ceil($total_prix_mesure_raisbas)+ceil($total_prix_mesure_raishaut)+ceil($total_prix_mesure_dormant)+ceil($total_prix_mesure_hauteur_couvre_joint)+ceil($total_prix_mesure_largeur_couvre_joint)+ceil($total_prix_mesure_sernie)+ceil($total_prix_mesure_chicone)+ceil($total_prix_mesure_traverse) ?></td>
    </tr>
     <tr>
