...
?>
    ...
    <tr>
      <td class="span1"><?php echo number_format( $rd_detail_mirroir->getHauteurMin(), 0, '.', ' ' )?></td>
      <td class="span1"><?php echo number_format( $rd_detail_mirroir->getLargeurMin(), 0, '.', ' ' )?></td>
      <td class="span1"><?php echo number_format( $rd_detail_mirroir->getQuantite(), 0, '.', ' ' )?></td>

      <td class="span1">glass</td>
      <td class="span1"><a href="<?php echo url_for('detailmirroir/edit?id='.$rd_detail_mirroir->getId()) ?>" class="crd_mng_lnk_02" >edit</a></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <a class="btn btn-success"href="<?php echo url_for('detailmirroir/viewquantity') ?>">View quantity on each sheet</a>
