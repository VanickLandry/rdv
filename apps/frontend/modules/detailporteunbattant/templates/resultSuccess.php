...
?>
	...
	$traverse140=($s_param_largeur_min -22);
	$hauteur_parclose30=($s_param_hauteur_min -31);
	$largeur_parclose30=($s_param_largeur_min -22);
	...
	$hauteur_couvre_joint=($s_param_hauteur_min+5);
	$largeur_couvre_joint=($s_param_largeur_min+10);
	$hjb=($s_param_hauteur_min-31);
	$ljb=($s_param_largeur_min-22);
...
$deleted = Doctrine_Query::create()
  ...
  ->execute();
	 ...
	 ?>
      ...
      <td><?php echo $hauteur_dormant ?> x 1</td>
      <td><?php echo $largeur_dormant ?> x 1</td>
      <td><?php echo $hauteur_zporte ?> x 1</td>
      <td><?php echo $largeur_zporte ?> x 1</td>
      <td><?php echo $traverse140 ?> x 2</td>
      <td><?php echo $hauteur_parclose30 ?> x 2</td>
      <td><?php echo $largeur_parclose30 ?>x 5</td>
      <td><?php echo $hauteur_couvre_joint ?> x 2</td>
      <td><?php echo $largeur_couvre_joint ?> x 1</td>
      <td><?php echo  $hjb ?> x 2</td>
      <td><?php echo  $ljb ?> x 4</td>
...
$totaltraverse140 = Doctrine_Query::create()
	  ...
	  foreach ($totaltraverse140 as $traverse140)
  {
    ...
    echo $totaltraverse140 =2*$traverse140->getTraverse140()." ";  
	  ...
	  foreach ($totalhauteur_parclose30 as $hauteur_parclose30)
  {
    ...
    $totalhauteur_parclose30 =2*$hauteur_parclose30->getHauteurParclose30(); 
	  ...
	  foreach ($totallargeur_parclose30 as $largeur_parclose30)
  {
    ...
    $totallargeur_parclose30 =5*$largeur_parclose30->getLargeurParclose30(); 
	  ...
	  foreach ($totalhauteur_couvre_joint as $hauteur_couvre_joint)
  {
     ...
     $totalhauteur_couvre_joint =2*$hauteur_couvre_joint->getHauteurCouvreJoint();  
    echo $totalhauteur_couvre_joint;  
	}?></td>
      <td><?php 
	  ...
	  foreach ($totallargeur_couvre_joint as $largeur_couvre_joint)
  {
     ...
     $totallargeur_couvre_joint =$largeur_couvre_joint->getLargeurCouvreJoint(); 
    echo $totallargeur_couvre_joint; 
	  ...
	  foreach ($totalhauteur_parclose30 as $hjb)
  {
    ...
    $totalhauteur_parclose30 =2*$hjb->getHjb(); 
    echo $totalhauteur_parclose30; 
	...
	<td>  <?php 
	  $totallargeur_parclose30 = Doctrine_Query::create()
						...
						// ->where('a.id=1')
 						->execute();
	  foreach ($totallargeur_parclose30 as $ljb)
  {
    	  
    $totallargeur_parclose30 =4*$hjb->getLjb(); 
    echo $totallargeur_parclose30; 
	 ...
	 foreach ($totallargeurvitre as $largeurvitre)
  {
	...
	$totalvitre =($totalhauteurvitre*$totallargeurvitre)/10000;
...
$dimension_mesure_hauteur_couvre_joint =$parammesure_hauteur_couvre_joint->getValeurNumeric();
	  $prix_mesure_hauteur_couvre_joint =$parammesure_hauteur_couvre_joint->getValeurString();
	   $total_prix_mesure_hauteur_couvre_joint =($prix_mesure_hauteur_couvre_joint/$dimension_mesure_hauteur_couvre_joint)*$totalhauteur_couvre_joint;

$piece_mesure_hauteur_couvre_joint =$totalhauteur_couvre_joint/$dimension_mesure_hauteur_couvre_joint;
		 }
...
$dimension_mesure_largeur_couvre_joint =$parammesure_largeur_couvre_joint->getValeurNumeric();
	  $prix_mesure_largeur_couvre_joint =$parammesure_largeur_couvre_joint->getValeurString();
	   $total_prix_mesure_largeur_couvre_joint =($prix_mesure_largeur_couvre_joint/$dimension_mesure_largeur_couvre_joint)*$totallargeur_couvre_joint;

$piece_mesure_largeur_couvre_joint =$totallargeur_couvre_joint/$dimension_mesure_largeur_couvre_joint;
		 }
...
;
     ...
     <tr>
	   ...
	   //echo number_format( $piece_mesure_hauteur_dormant, 2, '.', ' ' );
...
?></td>
    ...
    <td><?php echo  $largeur_vitre ?></td> </tr>
  </tbody>
</table>
...
<tr>
  ...
  <a class="btn btn-danger" href="<?php echo url_for('porteunbattant/new') ?>">Back</a>&nbsp;&nbsp;&nbsp;
  <a class="btn btn-danger" href="<?php echo url_for('detailporteunbattant/index') ?>">Cutting Plan</a>&nbsp;&nbsp;&nbsp;
  <a class="btn btn-primary" href="<?php echo url_for('detailporteunbattant/print') ?>" target="_blank">Print to technicians</a>&nbsp;&nbsp;&nbsp;
  <a class="btn btn-primary" href="<?php echo url_for('detailporteunbattant/printclient') ?>" target="_blank">Print to client</a>&nbsp;&nbsp;&nbsp;
