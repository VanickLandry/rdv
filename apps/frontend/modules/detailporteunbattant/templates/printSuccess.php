<link href="../css/rta_css_print.css" rel="stylesheet" type="text/css" />
...
<?php }  ?>
 <table width="80%" class="table table-bordered well" border="2">
  <thead>
    <tr>
		<th>&nbsp;</th>
        <th>Largeur</th>
...
$deleted = Doctrine_Query::create()
  ...
  ->execute();
	 ...
	 ?>
      ...
      <td><?php echo $traverse140 ?> /2</td>
      <td><?php echo $hauteur_parclose30 ?> /2</td>
      <td><?php echo $largeur_parclose30 ?> /5</td>
      <td><?php echo $hauteur_couvre_joint ?> /2</td>
      <td><?php echo $largeur_couvre_joint ?></td>
      <td><?php echo  $hjb ?> /2</td>
      <td><?php echo  $ljb ?> /4</td>
...
$totaltraverse140 = Doctrine_Query::create()
	  ...
	  foreach ($totalhauteur_couvre_joint as $hauteur_couvre_joint)
  {
     ...
     $totalhauteur_couvre_joint =$hauteur_couvre_joint->getHauteurCouvreJoint();  
...
?></td>
 ...
 ?>&nbsp;</td>
    ...
    <td colspan="2"><?php echo ceil($total_prix_mesure_vitre);?></td>   </tr>
     <tr>
...
<table width="80%" class=" table-condensed well">
  <thead>
    <tr>
