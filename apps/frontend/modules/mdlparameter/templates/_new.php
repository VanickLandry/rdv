...
<a id='btn_mdlparameter_ariane' href="<?php echo url_for('mdlparameter/'.($view_type == 'ajax' ? 'ajaxview' : '').'index') ?>" class="rta_lnk_03"  > Parametres </a> &gt; Ajouter parametre configuration
<?php end_slot() ?>

<?php slot('slot_module_title') ?>
<?php echo  __('Ajouter parametre configuration', null, 'rta_sf_dictionnary')  ?>
<?php end_slot() ?>
