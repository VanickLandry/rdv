 ...
 */
class CrdmgrCommissionFormFilter extends BaseCrdmgrCommissionFormFilter
{
  public function configure()
  {
    ...
    // -- champ auto: 
		...
		$this->useFields(array( 'is_active','institution_id','type_commission' ));
    ...
    */
 $this->widgetSchema['nom_agency'] = new sfWidgetFormInputText();
    # virtual form field
    ...
    ##$this->widgetSchema['nom_institut'] = new sfWidgetFormInputText();
    ...
    /*
      ...
      */
		...
		#$this->validatorSchema['nom_institut'] = new sfValidatorString(array('min_length' => 0, 'required' => false)
		#						, array(
		#						'required'   => 'Valeur requise',
		#						'min_length' => 'Valeur trop courte. elle doit avoir au moins %min_length% caracteres.',
		#					  ));
    
		$this->validatorSchema['nom_agency'] = new sfValidatorString(array('min_length' => 0, 'required' => false)
								, array(
								'required'   => 'Valeur requise',
								'min_length' => 'Valeur trop courte. elle doit avoir au moins %min_length% caracteres.',
							  ));
    ...
    # var_dump( $values );  echo $query->getSqlQuery();   exit(); # afficher la requete sql
		...
		*/
		...
		// Filtre  utilisateur
		if (isset($values['nom_agency']) && $values['nom_agency'] != "")
		{
			$query->addWhere("     ( nom_agence like ?    ) ", array ("%".trim($values['nom_agency'])."%" ));
		}
