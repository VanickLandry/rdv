...
/**
 * CrdmgrBulletinAdhesionDetail filter form base class.
 *
 * @package    credit_mng
 * @subpackage filter
 ...
 */
abstract class BaseCrdmgrBulletinAdhesionDetailFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'bulletin_adhesion_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CtrBulletinAdhesion'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'bulletin_adhesion_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CtrBulletinAdhesion'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('crdmgr_bulletin_adhesion_detail_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                   => 'Number',
      'bulletin_adhesion_id' => 'ForeignKey',
