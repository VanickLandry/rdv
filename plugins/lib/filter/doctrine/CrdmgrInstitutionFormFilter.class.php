...
/**
 * CrdmgrInstitution filter form.
 *
 * @package    credit_mng
 * @subpackage filter
 * @author     achille.tchapi@gmail.com at 20110926_085125
 * @version    SVN: $Id: sfDoctrineFormFilterTemplate.php 23810 2009-11-12 11:07:44Z Kris.Wallsmith $
 */
class CrdmgrInstitutionFormFilter extends BaseCrdmgrInstitutionFormFilter
{
    ...
    */
    ...
    # var_dump( $values );  echo $query->getSqlQuery();   exit(); # afficher la requete sql
		...
		*/
		...
		// Filtre  utilisateur
		if (isset($values['nom_institut']) && $values['nom_institut'] != "")
		{
			$query->addWhere("     ( nom_institution like ?    ) ", array ("%".trim($values['nom_institut'])."%" ));
		}
