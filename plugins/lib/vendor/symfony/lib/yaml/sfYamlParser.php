...
class sfYamlParser
{
  ...
  public function parse($value)
  {
    ...
    if (function_exists('mb_internal_encoding') && ((int) ini_get('mbstring.func_overload')) & 2)
    {
      ...
      {
          # echo  "<tchac line=".$this->getRealCurrentLineNb().">\n".$this->currentLine."</tchac>";  # @debug
          var_dump ($this->lines);
      }
      */
  ...
  protected function cleanup($value)
  {
    ...
    if ( isset ($tchac_debug ) && $tchac_debug == "exit") # @debug
    {
        echo  'protected function cleanup($value)' ;   # @debug
        # echo  "<tchac line=".$this->getRealCurrentLineNb().">\n".$this->currentLine."</tchac>";  # @debug
        # var_dump ($this->lines); # ainsi  $this->cleanup($value) retourne le vide
        var_dump ($value); 
    }
  ...
  */
  ...
  //  cleanup pris dans la version 1.4.6 de symfony
  protected function cleanup($value)
  {
    $value = str_replace(array("\r\n", "\r"), "\n", $value);
