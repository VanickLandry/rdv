...
/**
 * CrdmgrFicheConsentement form base class.
 *
 * @method CrdmgrFicheConsentement getObject() Returns the current form's model object
 *
 * @package    credit_mng
 * @subpackage form
 ...
 */
abstract class BaseCrdmgrFicheConsentementForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'code_fiche_consentement'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'code_fiche_consentement'        => new sfValidatorString(array('max_length' => 100)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'CrdmgrFicheConsentement', 'column' => array('code_fiche_consentement')))
    );

    $this->widgetSchema->setNameFormat('crdmgr_fiche_consentement[%s]');
