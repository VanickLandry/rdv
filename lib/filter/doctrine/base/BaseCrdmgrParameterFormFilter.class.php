...
abstract class BaseCrdmgrParameterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'code_parametre'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'code_parametre'    => new sfValidatorPass(array('required' => false)),
      'label_param'       => new sfValidatorPass(array('required' => false)),
      'valeur_string'     => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
