...
/**
 * RdMirroir filter form base class.
 *
 * @package    Rdv
 * @subpackage filter
 * @author     Bongas
 ...
 */
abstract class BaseRdMirroirFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rd_mirroir_filters[%s]');
